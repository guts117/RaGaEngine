#ifndef SSAO_BLUR_PASS_FBO_HANDLER
#define SSAO_BLUR_PASS_FBO_HANDLER
...
namespace NarakaKarEngine
{
	...
	{
		class Ssao_Blur_Pass_Fbo_Handler
		{
		public:
			Ssao_Blur_Pass_Fbo_Handler() = delete;
			explicit Ssao_Blur_Pass_Fbo_Handler(const GLuint& width, const GLuint& height);

			Ssao_Blur_Pass_Fbo_Handler(Ssao_Blur_Pass_Fbo_Handler&& rhs) noexcept = default;
			Ssao_Blur_Pass_Fbo_Handler& operator=(Ssao_Blur_Pass_Fbo_Handler&& rhs) noexcept = default;
